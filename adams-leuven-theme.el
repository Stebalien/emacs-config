...
(custom-theme-set-faces
 ...
 '(mode-line ((((class color) (min-colors 89)) (:foreground "#85CEEB" :background "#335EA8"))))
 '(mode-line-inactive ((((class color) (min-colors 89)) (:foreground "#F0F0EF" :background "#9B9C97"))))
 '(mode-line-buffer-id ((((class color) (min-colors 89)) (:weight bold :foreground "RoyalBlue3" :background "gray10"))))
 '(mode-line-emphasis ((((class color) (min-colors 89)) (:weight bold :foreground "white"))))
 '(mode-line-highlight ((((class color) (min-colors 89)) (:foreground "OrangeRed2"))))
 ...
 '(org-mode-line-clock ((((class color) (min-colors 89)) (:foreground "black" :background "#EEC900"))))
 '(org-mode-line-clock-overrun ((((class color) (min-colors 89)) (:weight bold  :foreground "white" :background "#FF4040"))))
